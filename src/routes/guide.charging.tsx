  ...
  head: () => ({
    meta: [
      { title: "Charging & Range — GV60 Full Guide" },
      {
        name: "description",
        content:
          "Charging targets, home charging, remote climate, and the range mindset Owen should keep.",
      },
      { property: "og:title", content: "Charging & Range — GV60" },
      {
        property: "og:description",
        content: "Moderate daily target, higher pre-trip, plug in for climate.",
      },
    ],
  }),
  component: Chapter,
  ...
  return (
    <div className="container-app py-8 space-y-8 pb-16">
      ...
      <div className="flex flex-wrap gap-2 pt-2">
        ...
        <Link to="/owen#target" className="text-xs text-primary self-center">
          Owen's charging defaults →
        </Link>
      </div>
    </div>
  );
