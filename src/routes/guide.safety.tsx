  ...
  head: () => ({
    meta: [
      { title: "Safety & Driver Assistance — GV60 Full Guide" },
      {
        name: "description",
        content:
          "Chapter 7: Safety and Driver Assistance for the 2023 Genesis GV60 Performance — mindset, systems, settings, and troubleshooting.",
      },
      { property: "og:title", content: "Safety & Driver Assistance — GV60" },
      {
        property: "og:description",
        content: "The full safety chapter, with Owen's recommended defaults.",
      },
    ],
  }),
    ...
    <div className="container-app py-8 space-y-8 pb-16">
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          These systems help you notice, react, and manage the vehicle more confidently — they don't
        ...
        <p className="text-sm italic text-primary">
          Owner: don't turn off a warning just because it surprised you once. Learn what it means
          first.
        </p>
      ...
      <FeatureCard
        ...
        bestFor={[
          "Reliable warnings",
          "Clear parking views",
          "Better lane behavior",
          "Predictable assistance",
        ]}
        changeWhen={[
          "Immediately after snow, ice, heavy rain, mud, road salt, car washes, bug buildup",
        ]}
      ...
      <FeatureCard
        ...
        bestFor={[
          ...
          "Urban driving",
          "Highway commuting",
          "Distracted-moment backup",
        ]}
        changeWhen={[
          "Heavy rain, snow, fog, sun glare, dirty sensors, construction, unusual traffic",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "If warnings happen often, add following distance before tweaking sensitivity",
        ]}
      ...
      <FeatureCard
        ...
        bestFor={[
          ...
          "City merging",
          "Multi-lane roads",
          "Shared-driver confidence",
        ]}
        changeWhen={[
          "Motorcycles, fast-approach vehicles, rain, snow/mud on sensors, curved roads",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Poor markings, merges, construction, sharp curves, weather, dirty camera area",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Construction, heavy rain, snow, fog, city streets, aggressive traffic, poor markings, complex merges, school zones",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Shorten only in clear conditions when you understand the behavior and stay fully attentive",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Shifting construction lanes, poor weather, disappearing markings, aggressive traffic, if you start disengaging mentally",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Heavy traffic, rain, snow, construction, fast-approach vehicles, near exits or merges",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Large vehicles blocking sensors, fast traffic, small objects, snow/mud on sensors, tight angles",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Very low or thin objects, soft/angled obstacles, moving children or pets, curbs hidden below camera view",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Always check manually for cyclists, scooters, motorcycles, delivery vehicles",
        ]}
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Data may be wrong due to construction, temporary signs, school-zone timing, map issues",
        ]}
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        />
        <p className="text-sm text-muted-foreground">
          Watch for children, carts, reversing vehicles, pedestrians between cars, curbs, poles,
          distracted drivers.
        </p>
        <p className="text-sm italic text-primary">
          Owner: parking lots aren't low-risk just because speeds are low.
        </p>
      </section>
      ...
      <FeatureCard
        ...
        changeWhen={[
          "Poor lighting, damaged connectors, other EVs backing in — pause and reassess",
        ]}
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        />
        <p className="text-sm italic text-primary">
          Owner: lower regen when carrying pets. Abrupt lift-off is uncomfortable for them.
        </p>
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        />
        <p className="text-sm italic text-primary">
          Owner: if night driving feels tiring, lower HUD/screen brightness before blaming
          headlights.
        </p>
      </section>
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        />
        <p className="text-sm italic text-primary">
          Owner: in rain, smoothness is safety. Avoid sudden inputs.
        </p>
      </section>
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        />
        <p className="text-sm italic text-primary">
          Owner: no safety system overcomes bad traction. Tires, speed, and smoothness matter most.
        </p>
      </section>
      ...
      <FeatureCard
        ...
        bestFor={[
          ...
          "Service procedures",
          "Sensor blockage",
          "False warnings from special conditions",
        ]}
        changeWhen={[
          "Set a reminder to re-enable — 'temporary off' shouldn't become 'permanently forgotten'",
        ]}
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        <ul className="text-sm space-y-2 text-muted-foreground">
          <li>
            <strong className="text-foreground">Forward warnings happen too often →</strong> check
            following distance, driving style, warning sensitivity, traffic, sensor cleanliness.
          </li>
          <li>
            <strong className="text-foreground">Blind-spot warning inconsistent →</strong> clean
            rear/side sensor areas; fast-approaching vehicles behave differently.
          </li>
          <li>
            <strong className="text-foreground">Lane system confused →</strong> check markings,
            windshield camera area, weather, construction, status icons.
          </li>
          <li>
            <strong className="text-foreground">Smart Cruise brakes too hard →</strong> increase
            following distance; retest in lighter traffic.
          </li>
          <li>
            <strong className="text-foreground">Parking sensors beep too much →</strong> proximity
            to curbs, walls, poles, bikes, snow, sensor dirt.
          </li>
          <li>
            <strong className="text-foreground">Camera view blurry →</strong> clean the lens gently.
          </li>
          <li>
            <strong className="text-foreground">Rear cross-traffic fails to alert →</strong> back
            out slower, clean sensors, parked vehicles can block detection.
          </li>
          <li>
            <strong className="text-foreground">Driver assistance unavailable →</strong> check for
            blocked cameras/sensors from snow, mud, glare, rain.
          </li>
        </ul>
        <p className="text-sm italic text-primary">
          Owner: most complaints are one of four things — dirty sensors, bad weather, unclear road
          markings, or a setting you haven't learned yet.
        </p>
      </section>

      <section className="space-y-3">
        <h2 className="text-xl font-display font-semibold">
          7.31 Recommended Safety Settings Cards
        </h2>
        ...
        <div className="grid gap-3">
          <QuickCard
            ...
            rows={[
              ...
              ["Parking Sensors", "On"],
              ["Lane Alerts", "On"],
              ["Cruise Distance", "Medium–long"],
              ["Camera", "Use often"],
              ["Warning Volume", "Audible + comfortable"],
            ]}
          />
          <QuickCard
            title="Highway"
            rows={[
              ["Drive Mode", "Comfort"],
              ["Smart Cruise", "Good conditions only"],
              ["Following Distance", "Medium–long"],
              ["Lane Assist", "On, monitor"],
              ["Blind-Spot", "On"],
              ["Navigation", "Active before departure"],
              ["Driver Attention", "Full"],
              ["Weather", "Avoid assist reliance in poor weather"],
            ]}
          />
          <QuickCard
            title="Parking"
            rows={[
              ...
              ["Rear Cross-Traffic", "On"],
              ["Speed", "Very slow"],
              ["Mirrors", "Use with camera"],
              ["Auto Hold", "Use carefully"],
              ["Direct Vision", "Always check"],
            ]}
          />
          <QuickCard
            title="Rain"
            rows={[
              ...
              ["Following Distance", "Longer"],
              ["Wipers", "Ready"],
              ["Headlights", "On when needed"],
              ["Cruise", "Cautious use only"],
              ["Lane Assistance", "Monitor closely"],
            ]}
          />
          <QuickCard
            title="Winter"
            rows={[
              ...
              ["Regen", "Low to moderate"],
              ["Following Distance", "Much longer"],
              ["Climate", "Precondition"],
              ["Tires", "Check condition/pressure"],
              ["Sensors", "Clear before driving"],
              ["Speed", "Conservative"],
            ]}
          />
          <QuickCard
            title="Shared Driver"
            rows={[
              ["Profile", "Separate per driver"],
              ["Safety Alerts", "Keep on"],
              ["Drive Mode", "Comfort"],
              ["Regen", "Level 1–2"],
              ["Cruise", "Teach before use"],
              ["Parking Camera", "Demonstrate"],
              ["Boost", "Explain restrictions"],
            ]}
          />
        </div>
      </section>
      ...
      <section className="card-glass p-5 space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          GV60 safety systems work best when you understand their limits.
        </p>
        <div>
        ...
        <p className="text-sm italic text-primary">
          Owner: the safest GV60 setup isn't the one with the most tech turned on blindly. It's the
          one where the driver understands each system, keeps sensors clean, uses conservative
          settings, and stays fully engaged.
        </p>
      </section>

      <div className="flex flex-wrap gap-2 pt-2">
        <Chip tone="primary">Chapter 05 · Safety</Chip>
        <Link to="/owen#alerts" className="text-xs text-primary self-center">
          See Owen's alert defaults →
        </Link>
      </div>
    </div>
  );
