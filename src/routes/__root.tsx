...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A personalized in-car companion guide for Owen Reagan's 2023 Genesis GV60 Performance — recommended settings, quick-start checklists, and the full owner guide." },
      { property: "og:title", content: "Owen's GV60 Companion" },
      { property: "og:description", content: "Personalized owner companion for Owen Reagan's 2023 Genesis GV60 Performance." },
