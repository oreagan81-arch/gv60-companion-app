    ...
    <div className="container-app py-8 space-y-6 pb-16">
      ...
      <div className="card-glass p-5 space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          The Quick Start mode walks Owen through the essentials with saved
          progress, so it can be paused and resumed while sitting in the car.
        </p>
        <Link to="/quick-start" className="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">
          Open Quick Start →
        </Link>
      </div>
      ...
      <div className="card-glass p-4 text-sm text-muted-foreground">
        ...
        <Link to="/full-guide/driving" className="text-primary">Driving Like a Pro</Link> or{" "}
        <Link to="/settings" className="text-primary">Owen's recommended settings</Link>.
      </div>
    </div>
  );
}
