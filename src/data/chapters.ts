...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    summary:
      "Smooth EV driving, drive modes, regen paddles, Smart Cruise habits, bad-weather adjustments, parking confidence, and performance boundaries.",
    status: "Expanded",
    ...
    sections: [
      {
        id: "mindset",
        title: "Smooth EV driving mindset",
        body: "The GV60 Performance is quick, quiet, and heavy. Smooth driving means using the right mode, gentle accelerator inputs, predictable regen, and conservative following distance instead of treating every drive like a launch demo.",
        recommendedSetting: "Comfort mode, Auto Regen or Level 2, longer following distance.",
        bestFor: ["First week driving", "Passenger comfort", "Learning the car calmly"],
        changeItWhen: ["Road, weather, traffic, or passenger needs clearly change"],
        ownerSuggestion:
          "Use Comfort as the reset button. If any setting feels confusing, return to Comfort and Auto Regen or Level 2.",
        troubleshooting:
          "If the car feels jumpy, check drive mode and regen level before changing anything deeper.",
      },
      {
        id: "comfort-mode",
        title: "Comfort mode",
        body: "Comfort is the daily baseline. It keeps the GV60 responsive without making throttle, steering, or regen feel dramatic.",
        recommendedSetting: "Use Comfort mode as Owen's default.",
        bestFor: ["Daily driving", "Passengers", "Learning the vehicle"],
        changeItWhen: ["Range, weather, snow, or performance needs call for another mode"],
        ownerSuggestion: "Comfort first. Learn normal before adding Sport, Sport+, or Boost.",
        imagePlaceholder: "Drive Mode selector",
        relatedLinks: [{ to: "/settings", label: "Everyday settings" }],
      },
      {
        id: "eco-mode",
        title: "Eco mode",
        body: "Eco softens response and can reduce climate and power draw. It is useful when efficiency matters more than punch.",
        recommendedSetting: "Use Eco for range-focused drives, rain, or relaxed highway cruising.",
        bestFor: ["Efficiency", "Wet roads", "Low battery cushion"],
        changeItWhen: ["You need sharper response for merging or grades"],
        ownerSuggestion: "Eco is a tool, not a punishment. Use it when calm range matters.",
      },
      {
        id: "sport-modes",
        title: "Sport and Sport+ modes",
        body: "Sport and Sport+ sharpen the car. They are best saved for dry, open, legal roads after Owen already understands the cabin, regen, and driver-assistance behavior.",
        recommendedSetting:
          "Sport only intentionally. Sport+ only when conditions are dry and safe.",
        bestFor: ["Empty on-ramps", "Dry fun roads", "Performance familiarity"],
        changeItWhen: ["Roads are wet, passengers are aboard, or traffic is dense"],
        ownerSuggestion: "If you are still learning the controls, stay out of Sport+.",
        imagePlaceholder: "Driving mode comparison card",
        relatedLinks: [{ to: "/settings", label: "Performance settings" }],
      },
      {
        id: "snow-my-mode",
        title: "Snow mode and My Mode",
        body: "Snow mode calms the vehicle for low-traction conditions. My Mode, if equipped/configured, lets Owen combine preferred steering, power, and regen behavior.",
        recommendedSetting: "Winter: Snow, Eco, or Comfort with low-to-moderate regen.",
        bestFor: ["Snow", "Ice", "Slush", "Personalized setup once the basics are learned"],
        changeItWhen: ["Roads clear and dry, or My Mode feels confusing"],
        ownerSuggestion: "Do not build a My Mode until Comfort mode feels completely familiar.",
      },
      {
        id: "boost",
        title: "Boost mode",
        body: "Boost is a short special-use performance feature on the GV60 Performance. It is not a daily driving style and it should not be used casually while learning the car.",
        recommendedSetting: "Special-use only. Dry, open, legal, and deliberate.",
        bestFor: ["Brief demonstrations", "Safe open-road acceleration", "Experienced drivers"],
        changeItWhen: ["Any traction, traffic, passenger, or comfort concern exists"],
        ownerSuggestion: "Treat Boost as special-use only. The car is already quick without it.",
        troubleshooting:
          "If Boost is unavailable, check drive state, battery/temperature limits, and cluster messages.",
        imagePlaceholder: "Boost button",
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "Boost button location" }],
      },
      {
        id: "when-not-boost",
        title: "When not to use Boost",
        body: "Skip Boost in rain, snow, traffic, tight roads, parking lots, with nervous passengers, with pets or fragile cargo, or anytime the driver is still learning another control.",
        recommendedSetting: "When in doubt, do not press it.",
        bestFor: ["Passenger trust", "Traction margin", "Keeping learning calm"],
        changeItWhen: ["Conditions are controlled and the driver is fully familiar"],
        ownerSuggestion: "There is no prize for surprising your passengers.",
      },
      {
        id: "regen-basics",
        title: "Regenerative braking basics",
        body: "Regen controls how much the car slows when lifting off the accelerator. The regen paddles are a major daily-driving control, not a novelty.",
        recommendedSetting: "Start with Auto Regen or Level 2.",
        bestFor: ["Traffic", "Efficiency", "Learning EV smoothness"],
        changeItWhen: ["Passengers feel head-toss or roads get slick"],
        ownerSuggestion: "Use Level 1-2 regen for passengers. Smoothness beats maximum regen.",
        imagePlaceholder: "Regen paddles",
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "Regen paddle controls" }],
      },
      {
        id: "regen-levels",
        title: "Regen Level 0, 1, 2, and 3",
        body: "Level 0 coasts most freely. Level 1 is gentle. Level 2 is Owen's predictable daily feel. Level 3 slows more assertively and can be useful in traffic or descents.",
        recommendedSetting: "Level 2 for solo daily use, Level 1-2 for passengers.",
        bestFor: ["Matching road flow", "Passenger comfort", "Efficiency practice"],
        changeItWhen: ["Traffic opens up, roads are slick, or passengers feel motion"],
        ownerSuggestion: "Do not chase the highest regen number. Chase the smoothest drive.",
        imagePlaceholder: "Driver cluster showing regen level",
      },
      {
        id: "auto-regen-ipedal",
        title: "Auto Regen and i-Pedal",
        body: "Auto Regen adjusts deceleration based on conditions. i-Pedal or one-pedal-style driving, if available, can be convenient but requires smooth feet and awareness of passenger comfort.",
        recommendedSetting:
          "Auto Regen as a learner default; i-Pedal only after basic regen feels natural.",
        bestFor: ["City traffic", "Solo practice", "Consistent EV feel"],
        changeItWhen: [
          "Passengers, pets, fragile cargo, rain, snow, or fatigue make smoothness harder",
        ],
        ownerSuggestion: "Auto Regen is the easy button. i-Pedal is not mandatory.",
        imagePlaceholder: "Auto Regen / i-Pedal indicator if available",
      },
      {
        id: "smooth-inputs",
        title: "Smooth braking and acceleration",
        body: "EV torque arrives immediately, so small inputs matter. Smooth acceleration starts with ankle control; smooth braking blends regen and friction brakes without sudden final stops.",
        recommendedSetting: "Use gradual accelerator input and finish stops gently.",
        bestFor: ["Passenger comfort", "Pets", "Fragile cargo", "Wet roads"],
        changeItWhen: ["Emergency braking or evasive action is needed"],
        ownerSuggestion: "Drive like there is coffee in the cupholder.",
      },
      {
        id: "city-highway",
        title: "City and highway driving",
        body: "City driving rewards smooth regen and camera habits. Highway driving rewards conservative following distance, steady speed, and measured Smart Cruise use.",
        recommendedSetting:
          "City: Comfort + Auto/Level 2. Highway: Comfort or Eco + longer following distance.",
        bestFor: ["Commutes", "Errands", "Longer drives"],
        changeItWhen: ["Traffic, weather, or range goals change"],
        ownerSuggestion: "Use battery percentage as primary reference; range is only a forecast.",
      },
      {
        id: "weather-driving",
        title: "Rain, snow, ice, hills, and mountain roads",
        body: "Bad weather and grades reward patience. Rain favors Eco or Comfort with lower regen. Winter favors Snow, Eco, or Comfort. Hills and mountains require planning speed, regen, and brake temperature awareness.",
        recommendedSetting:
          "Rain: Eco or Comfort. Winter: Snow, Eco, or Comfort. Regen low-to-moderate.",
        bestFor: ["Wet commutes", "Snow days", "Mountain descents"],
        changeItWhen: ["Roads dry out or traction improves"],
        ownerSuggestion:
          "Smoothness is safety in weather. Lower regen before the road asks you to.",
        relatedLinks: [{ to: "/settings", label: "Rain and winter settings" }],
      },
      {
        id: "smart-cruise",
        title: "Smart Cruise, following distance, and lane support",
        body: "Smart Cruise can reduce fatigue, and Lane Following / Highway Driving Assist can help with lane support where available. Treat these systems as assistance, not autonomy.",
        recommendedSetting: "Keep following distance conservative while learning Smart Cruise.",
        bestFor: ["Highways", "Fatigue reduction", "Steady traffic"],
        changeItWhen: ["Rain, construction, faded lanes, or dense traffic reduce confidence"],
        ownerSuggestion: "Driver assistance is support, not permission to stop driving.",
        troubleshooting:
          "If Smart Cruise will not engage, check speed, sensor visibility, seatbelt/brake status, and cluster messages.",
        imagePlaceholders: ["Smart Cruise display", "Lane assistance display"],
        relatedLinks: [{ to: "/full-guide/safety", label: "Driver assistance details" }],
      },
      {
        id: "assisted-lane-change",
        title: "Assisted lane change if equipped",
        body: "Assisted lane change depends on equipment, markings, speed, and sensor confidence. It should only be used after Owen understands normal lane support.",
        recommendedSetting: "Use only on clear highways with full driver supervision.",
        bestFor: ["Open highways", "Clear lane markings"],
        changeItWhen: ["Traffic is dense or the system feels uncertain"],
        ownerSuggestion: "Signal, check, supervise. The driver owns the lane change.",
      },
      {
        id: "parking-lots",
        title: "Parking-lot driving and 360 camera habits",
        body: "The GV60 is easiest to place when Owen uses the 360 camera early rather than late. Parking lots, backing into spaces, and public charger parking all reward slow inputs.",
        recommendedSetting: "Open the camera before the tight part starts.",
        bestFor: ["Garages", "Curbs", "Backing into spaces", "Public charger parking"],
        changeItWhen: ["Camera view is dirty or direct sight is better"],
        ownerSuggestion: "Use the 360 camera often at first. Build the mental map.",
        imagePlaceholders: [
          "360 camera screen",
          "Parking camera button",
          "Public charger parking view",
        ],
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "Camera button" }],
      },
      {
        id: "drive-through-car-wash",
        title: "Drive-throughs and car wash driving",
        body: "Drive-throughs need gentle creeping and awareness of Auto Hold. Car washes may require a specific neutral/vehicle-state procedure; follow the wash and owner manual instructions.",
        recommendedSetting:
          "Turn off Auto Hold when creeping matters. Confirm neutral guidance before a conveyor wash.",
        bestFor: ["Tight low-speed control", "Avoiding surprise hold/release behavior"],
        changeItWhen: ["Normal traffic resumes"],
        ownerSuggestion:
          "If Auto Hold makes the car feel weird in a queue, turn it off for that moment.",
        imagePlaceholder: "Car wash / neutral guidance card",
      },
      {
        id: "road-trip-rhythm",
        title: "Road-trip driving rhythm and efficiency habits",
        body: "Road trips are smoother with steady speeds, native navigation for EV-aware charger routing, planned stops, and battery percentage as the primary reference.",
        recommendedSetting: "Use native nav for charging trips; precondition for DC fast charging.",
        bestFor: ["Long drives", "Charging stops", "Winter trips"],
        changeItWhen: ["Trip is local and comfortably within range"],
        ownerSuggestion:
          "Percent first, range estimate second. Range is a weather report, not a contract.",
        relatedLinks: [{ to: "/full-guide/charging", label: "Road-trip charging" }],
      },
      {
        id: "performance-boundaries",
        title: "Performance driving boundaries",
        body: "Performance driving belongs in safe, legal, dry conditions with a driver who already understands the cabin, regen, tires, and assistance limits.",
        recommendedSetting: "Build skill slowly; leave margin.",
        bestFor: ["Responsible enjoyment", "Dry roads", "Experienced drivers"],
        changeItWhen: ["Passengers, traffic, weather, or fatigue enter the picture"],
        ownerSuggestion: "The car has more performance than most roads need. Respect that.",
      },
      {
        id: "emergency-practice",
        title: "Emergency practice",
        body: "Practice finding hazards, camera, defrost, wipers, and assistance status while parked. Know what the car feels like under firm braking in a safe environment.",
        recommendedSetting:
          "Practice controls parked; practice emergency stops only in a safe, legal open area.",
        bestFor: ["Confidence", "Bad-weather readiness", "New-owner learning"],
        changeItWhen: ["Any practice would endanger people or property"],
        ownerSuggestion: "You do not rise to the occasion; you fall to the control you practiced.",
      },
      {
        id: "driver-assistance-limits",
        title: "Driver-assistance limits",
        body: "Driver assistance depends on cameras, radar, lane markings, traffic behavior, and weather. It can be excellent and still unavailable or wrong in edge cases.",
        recommendedSetting:
          "Keep alerts on and learn what each status icon means before changing sensitivity.",
        bestFor: ["Trustworthy use", "Reducing surprises"],
        changeItWhen: ["The system repeatedly warns in a way you fully understand"],
        ownerSuggestion: "Clean sensors before assuming a system is broken.",
        relatedLinks: [{ to: "/full-guide/safety", label: "Safety systems" }],
      },
      {
        id: "driving-troubleshooting",
        title: "Driving troubleshooting",
        body: "Most driving-feel problems trace back to drive mode, regen level, Auto Hold, tire pressure, weather, or driver-assistance state.",
        recommendedSetting:
          "Reset to Comfort + Auto Regen or Level 2, then troubleshoot one variable at a time.",
        bestFor: ["Jumpy feel", "Unexpected slowdown", "Cruise confusion", "Parking weirdness"],
        changeItWhen: ["A warning message appears - follow it first"],
        troubleshooting:
          "If the car behaves unexpectedly, check cluster messages, drive mode, regen, Auto Hold, and tire pressure before assuming a fault.",
        relatedLinks: [{ to: "/troubleshooting", label: "Troubleshooting hub" }],
      },
      {
        id: "driving-summary",
        title: "Driving settings summary",
        body: "Owen's baseline is Comfort, Auto Regen or Level 2, conservative Smart Cruise distance, safety alerts on, cameras used early, Boost saved for special use, and battery percentage trusted over range estimates.",
        recommendedSetting: "Comfort daily. Auto Regen or Level 2. Level 1-2 for passengers.",
        bestFor: ["Daily repeatability", "Passenger comfort", "Efficient learning"],
        changeItWhen: ["Weather, trip, passenger, or performance context changes"],
        ownerSuggestion:
          "When confused, reset to the baseline. The baseline is there to rescue you.",
  ...
  },
  {
    ...
    summary:
      "Infotainment, driver profiles, HUD, voice, Device Connections, navigation, EV screens, Genesis app habits, OTA updates, and calm notification setup.",
    status: "Expanded",
    route: "/full-guide/technology",
    sections: [
      {
        id: "setup-order",
        title: "Technology setup order",
        body: "The GV60 technology stack works best when configured in order: driver profile, physical seat/mirror memory, primary phone, Device Connections, CarPlay, navigation preferences, EV charging settings, Genesis app, notifications, then display/HUD polish.",
        recommendedSetting:
          "Set driver profile before deep customization. Pair the primary phone first.",
        bestFor: ["First setup", "New phone", "Shared vehicle setup"],
        changeItWhen: ["A new regular driver is added"],
        ownerSuggestion:
          "Do not customize deep menus under the wrong profile. Profile first, phone second.",
        troubleshooting:
          "If settings do not stick, verify the active driver profile before changing them again.",
        relatedLinks: [
          { to: "/full-guide/cabin-tour", label: "Cabin setup order" },
          { to: "/settings", label: "Recommended Settings" },
        ],
      },
      {
        id: "infotainment-home",
        title: "Infotainment layout and home screen",
        body: "The center screen is the hub for setup, navigation, EV information, media, phone connections, and vehicle settings. Use it for configuration, not constant tapping while moving.",
        recommendedSetting:
          "Keep the home screen simple and learn where Setup, EV, Navigation, Media, and Device Connections live.",
        bestFor: ["Daily orientation", "Passenger-controlled tasks", "Setup work"],
        changeItWhen: ["A shortcut or tile never gets used"],
        ownerSuggestion:
          "The home screen should reduce decisions, not advertise every feature at once.",
        imagePlaceholder: "Infotainment home screen",
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "Center touchscreen" }],
      },
      {
        id: "cluster",
        title: "Driver cluster views and customization",
        body: "The driver cluster shows speed, battery/range, regen, driver-assistance state, warnings, and route cues. It should stay readable before it gets decorative.",
        recommendedSetting:
          "Use a clean view focused on speed, battery percentage, regen, and assistance status.",
        bestFor: ["Driving awareness", "Regen feedback", "Warnings"],
        changeItWhen: ["A theme hides information Owen needs often"],
        ownerSuggestion: "Battery percentage is the primary reference; range is a forecast.",
        imagePlaceholder: "Driver display / cluster",
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "Driver display basics" }],
      },
      {
        id: "hud",
        title: "Head-up display options",
        body: "The HUD can show key driving information near the road view. It is most useful when subtle and least useful when it becomes another cluttered screen.",
        recommendedSetting:
          "Speed and essential guidance only. Adjust height and brightness for comfort.",
        bestFor: ["Keeping eyes up", "Speed awareness", "Native navigation prompts"],
        changeItWhen: ["Night glare, windshield reflections, or clutter distracts"],
        ownerSuggestion: "Use the HUD subtly, not cluttered.",
        imagePlaceholder: "HUD settings screen",
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "HUD overview" }],
      },
      {
        id: "voice",
        title: "Voice control and natural language commands",
        body: "The GV60 has vehicle voice functions, while CarPlay brings Siri. Vehicle voice is for car-side tasks; Siri is for phone, messages, Apple Maps, music, calls, and reminders.",
        recommendedSetting: "Learn short-press versus long-press voice behavior while parked.",
        bestFor: ["Hands-free commands", "Reducing screen use"],
        changeItWhen: [
          "CarPlay is disconnected or a command belongs to the car instead of the phone",
        ],
        ownerSuggestion: "Siri for phone stuff; Genesis vehicle voice for car stuff.",
        troubleshooting:
          "If the wrong assistant responds, check press length and whether CarPlay is connected.",
        relatedLinks: [{ to: "/full-guide/apple", label: "Siri in the GV60" }],
      },
      {
        id: "profiles",
        title: "Driver profiles",
        body: "Driver profiles organize personal settings, display behavior, saved preferences, and phone relationships. They are the root of many 'why did it change?' questions.",
        recommendedSetting:
          "One profile per regular driver. Load Owen's profile before changing settings.",
        bestFor: ["Shared vehicles", "Seat memory consistency", "Phone priority"],
        changeItWhen: ["A new regular driver uses the car"],
        ownerSuggestion: "If something feels like someone else's car, check profile first.",
        imagePlaceholder: "Driver profile screen",
        relatedLinks: [{ to: "/full-guide/cabin-tour", label: "Driver profile connection" }],
      },
      {
        id: "fingerprint",
        title: "Fingerprint login / biometrics if equipped",
        body: "Fingerprint or biometric login, if equipped, can make profile access easier. Treat it as convenience, not the only access path.",
        recommendedSetting:
          "Set up biometrics after the profile is correct and keep a normal backup access method.",
        bestFor: ["Quick profile access", "Shared vehicle convenience"],
        changeItWhen: ["A driver cannot reliably authenticate"],
        ownerSuggestion: "Fingerprint is a shortcut, not a plan B.",
        imagePlaceholder: "Fingerprint / biometric setup screen if equipped",
      },
      {
        id: "device-connections",
        title: "Device Connections",
        body: "Device Connections controls Bluetooth, paired phones, and phone projection handoff. It is where phone priority and wrong-phone problems usually begin.",
        recommendedSetting:
          "Use Device Connections to control which phone is primary. Pair Owen's primary phone first.",
        bestFor: ["CarPlay reliability", "Multiple phones", "Phone priority"],
        changeItWhen: ["A phone is replaced or a second regular driver is added"],
        ownerSuggestion: "Keep a backup cable in the car even when wireless CarPlay works.",
        troubleshooting:
          "If the wrong phone connects, disconnect it here and rebuild priority from the primary phone.",
        imagePlaceholder: "Device Connections screen",
        relatedLinks: [{ to: "/full-guide/apple", label: "Apple / CarPlay guide" }],
      },
      {
        id: "phone-projection",
        title: "Phone projection / CarPlay connection handoff",
        body: "CarPlay is the everyday surface for iPhone navigation, audio, calls, and messages. The car's native systems remain best for EV routing, vehicle settings, and charging-aware tasks.",
        recommendedSetting: "Wireless CarPlay for daily use; cable as backup.",
        bestFor: ["Apple Maps", "Music", "Messages", "Calls"],
        changeItWhen: ["Wireless CarPlay misbehaves or a long trip needs maximum reliability"],
        ownerSuggestion:
          "Use Apple CarPlay for everyday phone life; use native screens for vehicle life.",
        troubleshooting:
          "If audio works but the CarPlay screen does not, clean pair and test with the backup cable.",
        relatedLinks: [{ to: "/full-guide/apple", label: "CarPlay troubleshooting" }],
      },
      {
        id: "navigation",
        title: "Native navigation basics",
        body: "Native navigation can integrate with vehicle displays and EV-aware planning. Phone navigation is usually faster for daily destinations, but the car has the edge for charging trips.",
        recommendedSetting:
          "Native navigation for EV-aware road trips and preconditioning; Apple Maps for everyday routes.",
        bestFor: ["DC fast-charge planning", "HUD/cluster guidance", "Road trips"],
        changeItWhen: ["A simple local trip is easier through CarPlay"],
        ownerSuggestion: "If charging matters mid-trip, use native navigation before you leave.",
        imagePlaceholder: "Navigation route screen",
        relatedLinks: [
          { to: "/full-guide/apple", label: "Apple navigation setup" },
          { to: "/full-guide/charging", label: "Charging trips" },
        ],
      },
      {
        id: "ev-screen",
        title: "EV screen",
        body: "The EV screen gathers battery, range, energy, charging, and EV planning information. It is the best place to understand what the vehicle thinks about energy.",
        recommendedSetting:
          "Check EV screen before long drives, winter drives, and charging changes.",
        bestFor: ["Battery percentage", "Range context", "Energy use"],
        changeItWhen: ["Trip length, weather, or charge plan changes"],
        ownerSuggestion: "Percent first, range second. The EV screen makes that habit easy.",
        imagePlaceholder: "EV screen",
        relatedLinks: [{ to: "/full-guide/charging", label: "Charging guide" }],
      },
      {
        id: "charging-settings",
        title: "Charging settings screen",
        body: "Charging settings control charge target, schedules, current limits where available, and related EV behavior.",
        recommendedSetting:
          "Moderate daily charge target; raise before trips. Verify schedules before assuming charging failed.",
        bestFor: ["Home charging", "Road-trip prep", "Battery care"],
        changeItWhen: ["Tomorrow's drive needs more range"],
        ownerSuggestion: "Charge for the next drive, not for a perfect number.",
        troubleshooting:
          "If charging does not start, check schedule, target, connector, EVSE status, and app notifications.",
        imagePlaceholder: "Charging settings screen",
        relatedLinks: [{ to: "/full-guide/charging", label: "Charging settings" }],
      },
      {
        id: "range-battery",
        title: "Range / battery display",
        body: "The displayed range estimate reacts to weather, speed, terrain, climate, and recent driving. Battery percentage is the steadier planning reference.",
        recommendedSetting: "Use percentage as primary; range estimate as a forecast.",
        bestFor: ["Road trips", "Winter range", "Avoiding range anxiety"],
        changeItWhen: ["Conditions change enough that the forecast is stale"],
        ownerSuggestion: "A low-looking estimate is a question, not a verdict.",
        relatedLinks: [{ to: "/full-guide/charging", label: "Range planning" }],
      },
      {
        id: "genesis-app",
        title: "Genesis app / Bluelink connected services",
        body: "The Genesis app and Bluelink services can support remote climate, lock/unlock, vehicle status checks, charging status, and pre-trip checks depending on account, region, and subscription.",
        recommendedSetting:
          "Use the Genesis app for remote climate, charging status, lock status, and pre-trip checks.",
        bestFor: ["Remote climate", "Charging notifications", "Status checks"],
        changeItWhen: ["Signal, subscription, or account status prevents a command"],
        ownerSuggestion: "The app is for confirmation and prep, not panic-refreshing.",
        imagePlaceholder: "Genesis app remote climate/status screen",
        relatedLinks: [{ to: "/settings", label: "Technology settings" }],
      },
      {
        id: "remote-climate",
        title: "Remote climate",
        body: "Remote climate is one of the best EV comfort features, especially when the car is plugged in so cabin prep draws less from the battery.",
        recommendedSetting: "Use remote climate while plugged in whenever practical.",
        bestFor: ["Hot days", "Cold mornings", "Pre-trip comfort"],
        changeItWhen: ["Battery is low or the car is unplugged and range is tight"],
        ownerSuggestion: "Comfort before unplugging is one of the quiet luxuries of EV ownership.",
        troubleshooting:
          "If remote climate fails, check app login, signal, vehicle state, and charge level.",
        relatedLinks: [{ to: "/full-guide/charging", label: "Preconditioning and climate" }],
      },
      {
        id: "remote-status",
        title: "Remote lock/unlock and status checks",
        body: "Remote status checks can confirm lock state, charge state, and basic readiness. Remote lock/unlock can help with forgotten locks but should be verified in the app.",
        recommendedSetting:
          "Check status before long walks away from the car and before charging stops.",
        bestFor: ["Peace of mind", "Charging checks", "Pre-trip review"],
        changeItWhen: ["App status looks stale or signal is weak"],
        ownerSuggestion: "Trust but verify: look for a fresh timestamp.",
      },
      {
        id: "charging-notifications",
        title: "Charging notifications",
        body: "Charging notifications help catch failed sessions, completed charges, interrupted DC fast charging, and target confusion.",
        recommendedSetting:
          "Enable charging notifications in the Genesis app and phone notification settings.",
        bestFor: ["Home charging", "Public charging", "Road trips"],
        changeItWhen: ["Notifications become noisy after they are understood"],
        ownerSuggestion:
          "Charging alerts are worth keeping. A silent failed charge is worse than a noisy successful one.",
      },
      {
        id: "software-updates",
        title: "Software updates / OTA habits",
        body: "Software updates can fix real behavior across CarPlay, charging, maps, infotainment, and driver assistance. Do not chase tech problems before checking software updates.",
        recommendedSetting:
          "Check OTA/software status before troubleshooting persistent tech issues.",
        bestFor: ["CarPlay issues", "Map issues", "App glitches", "ADAS oddities"],
        changeItWhen: ["An update is available and the car can sit safely parked"],
        ownerSuggestion: "Update first, reboot/retry second, clean pair third.",
        troubleshooting:
          "If an update fails, retry on strong Wi-Fi while parked and with sufficient battery.",
        imagePlaceholder: "Software update screen",
        relatedLinks: [{ to: "/troubleshooting", label: "Software update confusion" }],
      },
      {
        id: "sound-settings",
        title: "Sound settings",
        body: "Sound settings tune tone, balance, prompts, and listening style. Keep them simple until Owen knows whether music, calls, or podcasts need a different profile.",
        recommendedSetting: "Start neutral. Use mild vocal emphasis for podcasts if needed.",
        bestFor: ["Music", "Podcasts", "Calls", "Navigation prompts"],
        changeItWhen: ["A source consistently sounds muddy or too sharp"],
        ownerSuggestion: "Do not tune sound around one bad recording.",
        imagePlaceholder: "Sound settings screen",
      },
      {
        id: "display-settings",
        title: "Display brightness and theme settings",
        body: "Brightness and theme settings affect eye comfort and distraction. The best setup is readable without pulling attention from the road.",
        recommendedSetting:
          "Use auto brightness/theme if comfortable; reduce night brightness if glare appears.",
        bestFor: ["Night driving", "Screen readability", "Reducing glare"],
        changeItWhen: ["Screen brightness competes with the windshield or mirrors"],
        ownerSuggestion: "Readable beats flashy.",
      },
      {
        id: "driver-assistance-settings",
        title: "Driver-assistance settings overview",
        body: "Driver-assistance settings control alerts, warnings, lane support, Smart Cruise behavior, and camera/sensor features. Keep them understandable before changing sensitivity.",
        recommendedSetting:
          "Safety alerts on at first. Learn each warning before disabling or reducing it.",
        bestFor: ["Trust building", "Smart Cruise", "Lane Following", "Highway Driving Assist"],
        changeItWhen: ["A warning is understood and repeatedly unhelpful"],
        ownerSuggestion: "Do not mute a system just because it surprised you once.",
        imagePlaceholder: "Driver assistance settings screen",
        relatedLinks: [{ to: "/full-guide/safety", label: "Safety guide" }],
      },
      {
        id: "calendar",
        title: "Calendar integration",
        body: "Calendar events with real addresses can surface route suggestions and reduce destination entry friction through Apple or native workflows.",
        recommendedSetting: "Put full street addresses in calendar events.",
        bestFor: ["Appointments", "Meetings", "Routine trips"],
        changeItWhen: ["Virtual events do not need destination data"],
        ownerSuggestion: "A clean calendar is a navigation feature.",
        relatedLinks: [{ to: "/full-guide/apple", label: "Calendar in CarPlay" }],
      },
      {
        id: "notification-privacy",
        title: "Notification privacy",
        body: "Notifications can leak personal context to passengers through screens, CarPlay, or announcements. Calm notification setup is part of cabin comfort.",
        recommendedSetting: "Driving Focus on. Announce Messages limited to Favorites if used.",
        bestFor: ["Passengers", "Privacy", "Reduced distraction"],
        changeItWhen: ["Expecting an urgent non-Favorite call or message"],
        ownerSuggestion: "Keep notifications calm. The car does not need your whole inbox.",
        relatedLinks: [{ to: "/full-guide/apple", label: "Driving Focus" }],
      },
      {
        id: "guest-valet",
        title: "Guest / valet setup",
        body: "Guest or valet setup protects personal settings, saved destinations, and phone behavior when someone else drives or parks the GV60.",
        recommendedSetting: "Use valet/guest mode when handing the car to someone else.",
        bestFor: ["Service visits", "Hotel valet", "Guest drivers"],
        changeItWhen: ["The vehicle is back with Owen"],
        ownerSuggestion: "Guest driver and valet are technology settings, not trust judgments.",
        imagePlaceholder: "Valet mode screen",
        relatedLinks: [{ to: "/settings", label: "Shared vehicle settings" }],
      },
      {
        id: "secondary-driver",
        title: "Secondary driver setup",
        body: "A second regular driver should have their own profile, seat memory, phone pairing, and notification expectations rather than borrowing Owen's setup.",
        recommendedSetting: "Create profile first, then seat/mirrors, then phone pairing.",
        bestFor: ["Household sharing", "Stable settings", "Fewer wrong-phone moments"],
        changeItWhen: ["A driver only needs one guest trip"],
        ownerSuggestion: "Do not share Apple IDs or profiles. Shared cars need separate setups.",
      },
      {
        id: "technology-troubleshooting",
        title: "Technology troubleshooting",
        body: "Most tech issues should be checked in order: active profile, software update, phone connection, vehicle state, app status, then deeper settings.",
        recommendedSetting: "Do not chase tech problems before checking software updates.",
        bestFor: ["CarPlay issues", "App issues", "Profile confusion", "Settings not sticking"],
        changeItWhen: ["A safety warning or vehicle message gives a direct instruction"],
        troubleshooting:
          "If a tech feature fails, note the exact message, check profile/software, reboot/retry, then use Troubleshooting.",
        imagePlaceholder: "Technology troubleshooting flowchart",
        relatedLinks: [{ to: "/troubleshooting", label: "Troubleshooting hub" }],
      },
      {
        id: "technology-summary",
        title: "Technology setup summary",
        body: "Profile first, primary phone first, Device Connections kept clean, CarPlay for everyday phone tasks, native navigation for EV-aware trips, Genesis app for remote climate/status/charging, calm notifications, and updates checked before deeper troubleshooting.",
        recommendedSetting: "Keep technology boring, predictable, and profile-aware.",
        bestFor: ["Reliable daily use", "Shared vehicle clarity", "Low-distraction driving"],
        changeItWhen: ["New phone, new driver, major update, or road-trip setup"],
        ownerSuggestion: "The best tech setup is the one Owen stops thinking about.",
      },
    ],
  },
  {
