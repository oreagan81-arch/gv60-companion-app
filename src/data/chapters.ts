...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    summary: "iPhone pairing, CarPlay, Apple Maps, AirPods, and Apple Watch support patterns.",
    status: "Draft",
    ...
    sections: [
      ...
      { id: "watch", title: "Apple Watch as a subtle support device — navigation prompts, charging & app notifications; not a primary driving interface" },
