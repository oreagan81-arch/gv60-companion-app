...
export const imageChecklist: ImageChecklistItem[] = [
  ...
  },
  {
    id: "seat-controls",
    title: "Seat controls",
    description: "Driver seat side controls, shot from the open door.",
    suggestedCaption: "Driver seat controls before saving memory.",
    altText: "GV60 driver seat side controls for position and support adjustment",
    chapter: "cabin-tour",
    priority: "High",
  },
  {
    ...
    description: "Door-mounted memory buttons close-up.",
    suggestedCaption: "Save memory positions after seat, steering wheel, and mirrors feel right.",
  ...
  },
  {
    id: "setup-menu",
    title: "Setup menu",
    description: "Center screen showing the main Setup menu.",
    suggestedCaption: "The Setup menu is the starting point for deeper vehicle settings.",
    altText: "GV60 center screen showing the Setup menu",
    chapter: "technology",
    priority: "Medium",
  },
  {
  ...
  },
  {
    ...
    description: "Profile selection or profile settings screen.",
    suggestedCaption: "Check the driver profile before changing settings.",
  ...
  },
  {
    ...
    title: "Fingerprint / biometric setup screen",
    description: "Biometric setup screen if equipped.",
    suggestedCaption: "Fingerprint login is convenience, not the only access path.",
    altText: "GV60 fingerprint or biometric setup screen if equipped",
    chapter: "technology",
    priority: "Low",
  },
  {
    ...
    description: "Vehicle software or OTA update status page.",
    suggestedCaption: "Check software before deep troubleshooting.",
  ...
  },
  {
    ...
    description: "Apple Maps active route shown through CarPlay.",
    suggestedCaption: "Apple Maps is the everyday navigation default.",
  ...
  },
  {
    ...
    description: "iPhone Driving Focus settings screen.",
    suggestedCaption: "Driving Focus keeps notifications calm.",
    altText: "iPhone Driving Focus settings for use with CarPlay",
    chapter: "apple",
    priority: "Low",
  },
  {
  ...
  },
  {
    ...
    description: "EV screen showing target, schedule, or charging settings.",
    suggestedCaption: "Charging settings control targets and schedules.",
    altText: "GV60 charging settings screen showing target or schedule options",
    chapter: "technology",
    priority: "High",
  },
  {
  ...
  },
  {
    ...
    description: "Center console gear selector with the Crystal Sphere visible.",
    suggestedCaption: "Crystal Sphere and gear selector in the center console.",
  ...
  },
  {
    id: "hud-settings",
    title: "HUD settings",
    description: "Head-up display settings page with height and brightness options.",
    suggestedCaption: "Keep the HUD useful and subtle.",
    altText: "GV60 head-up display settings screen",
    chapter: "technology",
    priority: "Medium",
  },
  {
  ...
  },
  {
    ...
    description: "Camera button on or near the center controls.",
    suggestedCaption: "Open the 360 camera before the tight part starts.",
    altText: "GV60 parking camera button in the center console controls",
    chapter: "driving",
    priority: "Medium",
  },
  {
  ...
  {
    id: "genesis-app-screen",
    title: "Genesis app screen",
    description: "Genesis app showing remote climate, lock status, or charging status.",
    suggestedCaption: "Use the Genesis app for remote climate and status checks.",
    altText: "Genesis app showing GV60 remote climate or vehicle status",
    chapter: "technology",
    priority: "High",
  },
  {
    id: "valet-mode-screen",
    title: "Valet mode screen",
    description: "Vehicle valet mode or guest setup screen.",
    suggestedCaption: "Use valet or guest setup before handing over the car.",
    altText: "GV60 valet mode or guest setup screen",
    chapter: "technology",
    priority: "Medium",
  },
  {
