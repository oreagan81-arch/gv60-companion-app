...
export const settingsCards: SettingsCard[] = [
  ...
  },
  {
    ...
    tag: "Setup",
    summary: "Profile first, primary phone first, calm notifications, updates before deep fixes.",
    items: [
      {
        feature: "Driver profile",
        setting: "Load Owen's profile before changing vehicle settings",
        why: "Profiles decide which preferences stick. Wrong profile means the right setting can look broken later.",
        changeWhen: "New regular driver -> create a separate profile instead of sharing Owen's.",
        bestFor: "Seat memory consistency, HUD preferences, phone priority, saved settings.",
        related: { to: "/full-guide/technology", label: "Technology guide" },
      },
      {
        feature: "Device Connections",
        setting: "Pair the primary phone first, then add secondary phones one at a time",
        why: "Clean phone priority prevents wrong-phone connects and CarPlay confusion.",
        changeWhen: "New phone, shared vehicle setup, or repeated CarPlay drops.",
        bestFor: "Reliable wireless CarPlay and predictable Bluetooth handoff.",
        related: { to: "/full-guide/apple", label: "Apple / CarPlay" },
      },
      {
        feature: "Software updates",
        setting: "Check OTA/software status before deep troubleshooting",
        why: "Updates can fix infotainment, CarPlay, charging, maps, and driver-assistance behavior.",
        changeWhen: "Install when parked, stable, and able to sit through the update.",
        bestFor: "Avoiding wasted time chasing bugs that are already fixed.",
      },
      {
        feature: "Notifications",
        setting: "Driving Focus on · messages/calls limited to what matters",
        why: "Calm notifications protect privacy and reduce distraction.",
        changeWhen: "Temporarily loosen only when expecting something urgent.",
        bestFor: "Passengers, privacy, and a quieter cabin.",
      },
      {
        feature: "Guest / valet",
        setting: "Use guest or valet setup before handing the car to someone else",
        why: "Protects saved places, personal settings, and phone behavior.",
        changeWhen: "Disable when the car is back with Owen.",
        bestFor: "Service visits, hotel valet, guest drivers.",
        related: { to: "/full-guide/technology", label: "Guest and valet setup" },
      },
    ],
  },
  {
